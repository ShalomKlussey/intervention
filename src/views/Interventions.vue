            ...
            <v-dialog v-model="dialog" max-width="500px">
              ...
              <v-card>
                ...
                <v-card-text>
                  <v-container>
                    <v-row>
                      <v-col><v-text-field v-model="editedItem.name" label="Parc"></v-text-field></v-col>
                      <v-col><v-text-field v-model="editedItem.location" label="Location"></v-text-field></v-col>

                    </v-row>

                    <v-row>
                      <v-col><v-text-field v-model="editedItem.extenteurs" label="Extincteur"></v-text-field></v-col>
                      <v-col><v-text-field v-model="editedItem.interventions" label="Intervention"></v-text-field></v-col>
                    ...
                    <v-row>
                      ...
                      <v-col><v-text-field type="date" v-model="editedItem.date_fin" label="Fin"></v-text-field></v-col>

                    </v-row>

                    <v-row>
                      <v-col><v-text-field label="Responsable"></v-text-field></v-col>
                      <v-col><v-text-field v-model="editedItem.statut" label="Statut"></v-text-field></v-col>
